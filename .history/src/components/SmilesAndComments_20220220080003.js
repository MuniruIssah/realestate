  ...
  return (
    <div className="w-full flex flex-col justify-center items-center space-y-10 p-10">
      ...
      <div className="flex space-x-20 justify-center items-center">
        ...
        <div className="basis-2/3 h-96 flex flex-no-wrap space-x-5 overflow-x-auto scroll-smooth scroll-pl-6 snap-x">
...
const SmilesAndCommentCard = ({ image, title, description, name, role }) => {
  return (
    <div className="snap-start w-full h-full flex-shrink-0 border border-teal-500 rounded rounded-lg">
      <div className="flex justify-center items-center space-x-10 p-10 h-full">
        ...
        <div className="h-full">
          <img
            src={image}
            alt={title}
            className="rounded rounder-lg w-120 h-full hidden md:block object-center"
          />
        </div>
      </div>
    </div>
