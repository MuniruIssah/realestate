...
const Services = () => {
  return (
    <div className="h-3/5 w-full flex flex-col justify-center items-center space-y-7 ">
      ...
      <div className=" flex  md:space-x-10 flex-wrap justify-center items-center w-full">
...
const ServicesCard = ({ image, service }) => {
  return (
    <div className="group w-1/4 border border-teal-200 hover:bg-teal-500 hover:ring-teal-500 rounded rounded-xl">
