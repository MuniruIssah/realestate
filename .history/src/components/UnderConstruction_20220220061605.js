...
const UnderConstruction = () => {
  return (
    <div className="w-full flex flex-col justify-center items-center space-y-10 p-7">
      ...
      <div className="flex flex-no-wrap  md:space-x-10 justify-center items-start w-full">
...
const UnderConstructionCard = ({ image, service,description }) => {
    return (
      <div className="group w-full my-5 md:w-36 border border-teal-200 hover:bg-teal-600 hover:ring-teal-600 rounded rounded-xl">
        <img
          src={image}
          alt="service"
