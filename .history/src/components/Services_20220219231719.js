...
const Services = () => {
  return (
    <div className="h-3/5 w-full flex flex-col justify-center items-center space-y-7 ">
      ...
      <div className="md:flex md:space-x-10 justify-around items-center w-full">
...
const ServicesCard = ({ image, name }) => {
  return (
    <div className="group flex-1 w-2/5 border border-teal-200 hover:bg-teal-500 hover:ring-teal-500">
