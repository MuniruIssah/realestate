...
const Services = () => {
  return (
    <div className="h-2/5 w-full flex flex-col justify-center items-center space-y-7 ">
...
const ServicesCard = ({ image, service }) => {
  return (
    <div className="group flex-1  border border-teal-200 hover:bg-teal-500 hover:ring-teal-500 rounded rounded-xl">
      <img src={image} alt="service" className="w-full h-32 object-cover rounded rounded-xl" />
