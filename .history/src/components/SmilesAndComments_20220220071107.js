...
import { MdOutlineArrowForwardIos,MdOutlineArrow } from "react-icons/md";
const commentList = [
  {
...
const SmilesAndComments = () => {
  return (
    <div className="w-full flex flex-col justify-center items-center space-y-10 p-10">
      ...
      </button> <button className="bg-teal-100 text-xs rounded rounded-full text-teal-600 p-2  self-end shadow-md">
        <MdOutlineArrowForwardIos />
      </button>
      </div>
