  ...
  return (
    <div className="w-full flex flex-col justify-center items-center space-y-10 p-10">
      ...
      <div className="flex space-x-10 justify-center items-center ">
        ...
        <div className="basis-2/3 flex flex-no-wrap space-x-10 overflow-x-auto scroll-smooth scroll-pl-6 snap-mandatory">
...
const SmilesAndCommentCard = ({ image, title, description, name, role }) => {
  return (
    <div className="w-full h-full  flex-shrink-0 border border-teal-500  snap-start rounded rounded-lg">
      <div className="flex justify-center items-center space-x-10 p-10"></div>
