...
const SmilesAndComments = () => {
  return (
    <div className="w-full flex flex-col justify-center items-center space-y-10 p-10">
      ...
      <div className="flex md:basis-1/3 md:space-x-20 justify-center items-center">
        ...
        <div className="flex-1 md:basis-1/3 h-96 flex flex-no-wrap  overflow-x-auto scroll-smooth snap-x snap-mandatory">
...
const SmilesAndCommentCard = ({ image, title, description, name, role }) => {
  return (
    <div className="snap-start w-full h-full flex-shrink-0 p-2 md:p-5 ">
      <div className="flex justify-center items-center space-x-10 border border-teal-500 rounded rounded-lg w-full h-full p-2 md:p-5">
