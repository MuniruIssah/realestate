  ...
  return (
    <div className="w-full flex flex-col justify-center items-center space-y-10 p-10">
      ...
      <div className="flex space-x-10 justify-center items-center ">
        ...
        <div className="basis-2/3 flex flex-no-wrap space-x-14 overflow-x-auto scroll-smooth scroll-pl-6 snap-mandatory">
...
const SmilesAndCommentCard = ({ image, title, description, name, role }) => {
  return (
    <div className="box-border w-full flex-shrink-0 border border-teal-500 flex justify-center items-center space-x-10 h-full snap-center rounded rounded-lg p-10 ">
