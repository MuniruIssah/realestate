...
const ServicesCard = ({ image, service }) => {
  return (
    <div className="group w-full my-3 md:w-1/5 border border-teal-200 hover:bg-teal-600 hover:ring-teal-600 rounded rounded-xl">
      <img
        src={image}
        alt="service"
      ...
      <button className="mx-3 m py-2 px-3 bg-white text-teal-600 group-hover:block hidden rounded rounded-2xl ">
        Know More
      </button>
    </div>
  );
