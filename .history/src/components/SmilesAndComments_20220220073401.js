  ...
  return (
    <div className="w-full flex flex-col justify-center items-center space-y-10 p-10">
      ...
      <div className="flex space-x-10 justify-center items-center ">
        ...
        <div className="basis-2/3 flex flex-no-wrap space-x-14 overflow-x-auto scroll-smooth scroll-pl-6 snap-x">
...
const SmilesAndCommentCard = ({ image, title, description, name, role }) => {
  return (
    <div className="w-full flex-shrink-0 border border-teal-500 flex justify-center items-center space-x-10 h-full snap-start rounded rounded-lg p-10 ">
      <div className="text-right flex flex-col">
        <CgQuote className="text-teal-600 text-4xl self-end" />
        <span className="font-semibold text-xs text-gray-600 my-2">
          {title}
        </span>
        <p className="text-gray-400 text-xs">
          {description}
        </p>
        <span className="font-bold text-sm text-gray-700 mt-3 mb-2">
            {name}
        </span>
