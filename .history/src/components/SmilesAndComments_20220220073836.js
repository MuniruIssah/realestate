...
const SmilesAndCommentCard = ({ image, title, description, name, role }) => {
  return (
    <div className="box-border w-full flex-shrink-0 border border-teal-500 flex justify-center items-center space-x-10 h-full snap-start rounded rounded-lg p-10 ">
