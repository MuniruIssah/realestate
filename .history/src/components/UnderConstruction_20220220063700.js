...
const UnderConstruction = () => {
  return (
    <div className="w-full flex flex-col justify-center items-center space-y-10 p-10">
      ...
      <div className="w-full flex flex-no-wrap space-x-10 overflow-x-auto scroll-smooth">
...
const UnderConstructionCard = ({ image, service,description }) => {
    return (
      <div className="group scroll-ml-6 flex-shrink-0 w-full my-5 md:w-52 border border-teal-200 hover:bg-teal-600 hover:ring-teal-600 rounded rounded-xl">
        <img
          src={image}
          alt="service"
