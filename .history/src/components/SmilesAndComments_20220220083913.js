...
const SmilesAndCommentCard = ({ image, title, description, name, role }) => {
  return (
    <div className="snap-start w-full h-full flex-shrink-0 p-5 ">
      <div className="flex justify-center items-center space-x-10 border border-teal-500 rounded rounded-lg w-full h-full p-">
