    ...
    <div className="w-full border border-teal-500 flex justify-center space-x-10 h-96">
      <div className="text-right">
        ...
        <p className="text-gray-400 text-xs">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum asperiores itaque vero consequatur placeat doloribus rerum magni dignissimos voluptatem eaque assumenda quasi 
        </p>
      </div>
      <div className="">
