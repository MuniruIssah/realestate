  ...
  return (
    <div className="w-full flex flex-col justify-center items-center space-y-10 p-10">
      ...
      <div className="flex space-x-20 justify-center items-center">
        ...
        <div className="basis-2/3 h-96 flex flex-no-wrap scroll-pl-20 overflow-x-auto scroll-smooth scroll-pl-6 snap-x snap-mandatory">
...
const SmilesAndCommentCard = ({ image, title, description, name, role }) => {
  return (
    <div className="snap-start w-full h-full flex-shrink-0 flex justify-center items-center">
      <div className="flex justify-center items-center space-x-10 border border-teal-500 rounded rounded-lg w-full">
