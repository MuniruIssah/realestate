  ...
  return (
    <div className="w-full border border-teal-500 flex justify-center space-x-10 h-96">
      <div className="text-right">
        <CgQuote className="text-teal-600 text-xl" />
        <span className="font-semibold text-gray-600">
            The court was drawn very properly
        </span>
        <p className="text-gray-400 text-xs">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum asperiores itaque vero consequatur placeat doloribus rerum magni dignissimos voluptatem eaque assumenda quasi necessitatibus, eligendi corporis earum deleniti velit dolorum ex!
        </p>
      </div>
      <div className="">
          <img src={image} alt="title" className="rounded rounder-lg h-full hidden md:block object-center" />
      </div>
    </div>
  );
};
